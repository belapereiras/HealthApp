...
class DateManagerTests: XCTestCase {
    ...
    func test_stringfying_second() {
        ...
        XCTAssert(stringfied_second.0 == "\(second)" &&
    ...
    func test_stringfying_seconds() {
        ...
        XCTAssert(stringfied_seconds.0 == "\(seconds)" &&
    ...
    func test_stringfying_minute() {
        ...
        XCTAssert(stringfied_minute.0 == "\(minute)" &&
    ...
    func test_stringfying_minutes() {
        ...
        XCTAssert(stringfied_minutes.0 == "\(minutes)" &&
    ...
    func test_stringfying_hour() {
        ...
        XCTAssert(stringfied_hour.0 == "\(hour)" &&
